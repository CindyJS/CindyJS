...
function uiStringCindy3D(meshFilename) {
    ...
    return (
        '<input type="checkbox" id="exportSpheres" onclick="cindyPrintUpdateExportSpheres()" checked> Spheres <image class=\'smallimg\' src=\'' +
        imageFolder +
        "SphereHighRes.png'/>" +
        '<input type="checkbox" id="exportCylinders" onclick="cindyPrintUpdateExportCylinders()" checked> Cylinders <image class=\'smallimg\' src=\'' +
        imageFolder +
        "CylinderHighRes.png'/>" +
        '<input type="checkbox" id="exportTriangles" onclick="cindyPrintUpdateExportTriangles()" checked> Triangles  <image class=\'smallimg\' src=\'' +
        imageFolder +
        "Triangles.png'/>" +
        "<br>" +
        "<table>" +
        "    <tr><th>Sphere quality</th><th><image src='" +
        imageFolder +
        'SphereLowRes.png\'/></th><th><div class="slidecontainer"><input type="range" min="8" max="64" value="16" class="slider" id="sphereQuality" oninput="cindyPrintUpdateSphereQuality()"></th><th><image src=\'' +
        imageFolder +
        "SphereHighRes.png'/></th></tr>" +
        "    <tr><th>Cylinder quality</th><th><image src='" +
        imageFolder +
        'CylinderLowRes.png\'/></th><th><div class="slidecontainer"><input type="range" min="8" max="64" value="16" class="slider" id="cylinderQuality" oninput="cindyPrintUpdateCylinderQuality()"></th><th><image src=\'' +
        imageFolder +
        "CylinderHighRes.png'/></th></tr>" +
        "    <tr><th>Radius factor</th><th><image src='" +
        imageFolder +
        'SphereSmall.png\'/></th><th><div class="slidecontainer"><input type="range" min="1" max="100" value="50" class="slider" id="radiusFactor" oninput="cindyPrintUpdateRadiusFactor()"></th><th><image src=\'' +
        imageFolder +
        "SphereHighRes.png'/></th></tr>" +
        "    <tr><th>Model scale</th><th><image src='" +
        imageFolder +
        'SizeSmall.png\'/></th><th><div class="slidecontainer"><input type="range" min="1" max="100" value="10" class="slider" id="modelScale" oninput="cindyPrintUpdateModelScale()"></th><th><image src=\'' +
        imageFolder +
        "SizeLarge.png'/></th></tr>" +
        "</table>" +
        '<input type="checkbox" id="extrudeSurfaces" onclick="cindyPrintUpdateExtrudeSurfaces()" checked> Extrude the triangle surfaces' +
        "<table>" +
        "    <tr><th>Extrusion radius</th><th><image src='" +
        imageFolder +
        'ExtrudeSurfaceSmall.png\'/></th><th><div class="slidecontainer"><input type="range" min="0" max="100" value="10" class="slider" id="extrusionRadius" oninput="cindyPrintUpdateExtrusionRadius()"></th><th><image src=\'' +
        imageFolder +
        "ExtrudeSurfaceLarge.png'/></th></tr>" +
        "</table>" +
        '<input type="checkbox" id="smoothEdges" onclick="cindyPrintUpdateSmoothEdges()" checked> Smooth extrusion edges<br>' +
        "<button onclick=\"cdy.evokeCS('savecsgmesh(&quot;" +
        meshFilename +
        "&quot;)');\">Export mesh</button>" +
...
function uiStringTubes(meshFilename, computeTubePointsFunctionName, numTubePointsString, radiusString, tubeClosed) {
    ...
    return (
        ...
        imageFolder +
        "CylinderHighRes.png'/></th></tr>" +
        "    <tr><th>Line subdivisions</th><th><image src='" +
        imageFolder +
        'LineSubdivisionLow.png\'/></th><th><div class="slidecontainer"><input type="range" min="1" max="100" value="50" class="slider" id="lineSubdivisions" oninput="cindyPrintUpdateLineSubdivisions()"></th><th><image src=\'' +
        imageFolder +
        "LineSubdivisionHigh.png'/></th></tr>" +
        "    <tr><th>Radius factor</th><th><image src='" +
        imageFolder +
        'TubeThin.png\'/></th><th><div class="slidecontainer"><input type="range" min="1" max="100" value="50" class="slider" id="radiusFactor" oninput="cindyPrintUpdateRadiusFactor()"></th><th><image src=\'' +
        imageFolder +
        "TubeThick.png'/></th></tr>" +
        "    <tr><th>Model scale</th><th><image src='" +
        imageFolder +
         ...
         */
        "<button onclick=\"cdy.evokeCS('savetubemesh(&quot;" +
        meshFilename +
        "&quot;, " +
        computeTubePointsFunctionName +
        "(' + document.getElementById('lineSubdivisions').value/50 + '*(" +
        numTubePointsString +
        ")), " +
        radiusString +
        "/20, " +
        tubeClosedString +
        ");');\">Export mesh</button>" +
        "<button onclick=\"cdy.evokeCS('updatepreviewtubes(" +
        computeTubePointsFunctionName +
        "(' + document.getElementById('lineSubdivisions').value/50 + '*(" +
        numTubePointsString +
        ")), " +
...
function uiStringCindyGL(meshFilename, updatepreviewcdyglArguments) {
    ...
    return (
        ...
        "    <tr><th>Sphere quality</th><th><image src='" +
        imageFolder +
        'SphereLowRes.png\'/></th><th><div class="slidecontainer"><input type="range" min="8" max="32" value="16" class="slider" id="sphereQuality" oninput="cindyPrintUpdateSphereQuality()"></th><th><image src=\'' +
        imageFolder +
        "SphereHighRes.png'/></th></tr>" +
        "    <tr><th>Model scale</th><th><image src='" +
        imageFolder +
        ...
        imageFolder +
        "SizeLarge.png'/></th></tr>" +
        "    <tr><th>Iso offset</th><th><image src='" +
        imageFolder +
        'IsoA.png\'/></th><th><div class="slidecontainer"><input type="range" min="0" max="100" value="0" class="slider" id="isoOffset" oninput="cindyPrintUpdateIsoOffset()"></th><th><image src=\'' +
        imageFolder +
        "IsoB.png'/></tr>" +
        "    <tr><th>Grid resolution</th><th><image src='" +
        imageFolder +
        'GridResLow.png\'/></th><th><div class="slidecontainer"><input type="range" min="16" max="128" value="50" class="slider" id="gridResolution" oninput="cindyPrintUpdateGridResolution()"></th><th><image src=\'' +
        imageFolder +
        "ExtrudeSurfaceSmall.png'/></th></tr>" +
        "</table>" +
        ...
        "<button onclick=\"cdy.evokeCS('saveisomeshtofile(&quot;" +
        meshFilename +
        "&quot;, " +
        updatepreviewcdyglArguments +
        ");');\">Export Mesh</button>" +
        "<button onclick=\"cdy.evokeCS('updatepreviewcdygl(" +
        updatepreviewcdyglArguments +
        ")');\">Update Preview</button>"
    );
}
...
function getCindyBaseDir() {
    if (cindyBaseDir !== null) return cindyBaseDir;
