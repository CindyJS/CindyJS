...
function initGLIfRequired() {
    ...
    if (!use8bittextures) {
        ...
        if (navigator.userAgent.match(/(iPad|iPhone)/i)) {
            //TODO: detect this better by checking wheather building a toy shader fails...
            ...
            if (
                ...
                console.error(
                    "Your browser does not suppert writing to half_float textures, we will use 8-bit textures."
                );
            }
        }
    }
