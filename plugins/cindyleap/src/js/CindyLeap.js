...
let CindyLeap = function (api) {
    ...
    defOp("leapnormalizeposition", 1, function (args, modifs) {
        ...
        let position = [cindyPosition[0].value.real, cindyPosition[1].value.real, cindyPosition[2].value.real];
    ...
    defOp("getleapmotionmodelmatrix", 0, function (args, modifs) {
        ...
        let leapMotionModelMatrixNested = [
            ...
            [
                leapMotionModelMatrix[12],
                leapMotionModelMatrix[13],
                leapMotionModelMatrix[14],
                leapMotionModelMatrix[15],
            ],
        ];
