...
describe("Quick hull", function () {
    ...
    describe("build from points", function () {
        ...
        var tests = [
            {
                args: [new Vector(-1, -1, -1), new Vector(-1, 1, 1), new Vector(1, -1, 1), new Vector(1, 1, -1)],
                expected: {
                    vertices: [
                        [-1, -1, -1],
                        [-1, 1, 1],
            ...
            describe(test.args.length + " points", function () {
                it("Resulting vertices", function () {
                    ...
                    result = hull.getVertices().map(function (point) {
                        return [point.value[0].value.real, point.value[1].value.real, point.value[2].value.real];
                    });
