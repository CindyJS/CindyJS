...
describe("all* operations", function () {
            ...
            geometry: [
                {
                    name: "A",
                    type: "Free",
                    pos: [2.6486486486486487, -4.0, -0.6756756756756757],
                    color: [1.0, 0.0, 0.0],
                    labeled: true,
                },
                {
                    name: "B",
                    type: "Free",
                    pos: [4.0, -3.183673469387755, -1.0204081632653061],
                    color: [1.0, 0.0, 0.0],
                    labeled: true,
                },
                {
                    name: "C",
                    type: "Free",
                    pos: [2.8888888888888893, -4.0, -2.7777777777777777],
                    color: [1.0, 0.0, 0.0],
                    labeled: true,
                },
                {
                    name: "D",
                    type: "Free",
                    pos: [-2.795180722891566, -4.0, -1.2048192771084338],
                    color: [1.0, 0.0, 0.0],
                    labeled: true,
                },
                {
                    name: "E",
                    type: "Free",
                    pos: [0.20382165605095542, -4.0, -0.6369426751592356],
                    color: [1.0, 0.0, 0.0],
                    labeled: true,
                },
                {
                    name: "F",
                    type: "Free",
                    pos: [4.0, 0.8928571428571428, 0.4464285714285714],
                    color: [1.0, 0.0, 0.0],
                    labeled: true,
                },
                {
                ...
                },
                {
                    name: "G",
                    type: "Free",
                    pos: [-1.6536312849162011, -4.0, -0.5586592178770949],
                    color: [1.0, 0.0, 0.0],
                    labeled: true,
                },
                {
                    name: "H",
                    type: "Free",
                    pos: [-3.4254143646408846, -4.0, -0.5524861878453039],
                    color: [1.0, 0.0, 0.0],
                    labeled: true,
                },
                {
                    name: "a",
                    type: "Segment",
                    pos: [0.013936311058462669, -0.5644205978677443, 4.0],
                    color: [0.0, 0.0, 1.0],
                    args: ["G", "H"],
                    labeled: true,
                    size: 1,
                },
                {
                    name: "K",
                    type: "Free",
                    pos: [4.0, 0.9929078014184397, -0.7092198581560284],
                    color: [1.0, 0.0, 0.0],
                    labeled: true,
                },
                {
                    name: "b",
                    type: "Through",
                    pos: [0.694924364585733, 0.0575904169546188, 4.0],
                    color: [0.0, 0.0, 1.0],
                    args: ["K"],
                    labeled: true,
                    size: 1,
                },
                {
                    name: "L",
                    type: "Free",
                    pos: [4.0, 0.6588235294117648, -1.1764705882352942],
                    color: [1.0, 0.0, 0.0],
                    labeled: true,
                },
                {
                    name: "M",
                    type: "Free",
                    pos: [0.8979591836734694, -4.0, 2.0408163265306123],
                    color: [1.0, 0.0, 0.0],
                    labeled: true,
                },
                {
                    name: "c",
                    type: "Segment",
                    pos: [0.8103727714748782, 2.2227367446168094, 4.0],
                    color: [0.0, 0.0, 1.0],
                    args: ["L", "M"],
                    render: true,
                    labeled: true,
                ...
                },
                {
                    name: "N",
                    type: "Free",
                    pos: [4.0, 0.7792207792207791, 1.2987012987012987],
                    color: [1.0, 0.0, 0.0],
                    labeled: true,
                },
                {
                    name: "O",
                    type: "Free",
                    pos: [4.0, -0.6419753086419752, 1.2345679012345678],
                    color: [1.0, 0.0, 0.0],
                    labeled: true,
                },
                {
    ...
    itCmd("allsprings()", "[c]");
    itCmd(
        "allelements()", // in the order in which they appear in the gslp
...
describe("toString as a name", function () {
    before(function () {
        cdy = CindyJS({
            isNode: true,
            csconsole: null,
            geometry: [{ name: "A", type: "Free", pos: [0, 0] }],
        });
    });
        ...
        cdy = CindyJS({
            ...
            geometry: [
                ...
                { name: "Collection__1", type: "IntersectionCircleCircle", args: ["C0", "C1"] },
                {
                    ...
                    pos: [
                        4.0,
                        { r: -0.697830520748037, i: 2.2070588312056207e-15 },
                        { r: -0.5503615798753269, i: 7.773440174097654e-17 },
                    ],
                    color: [1.0, 0.0, 0.0],
                    args: ["Collection__1"],
                    labeled: true,
                },
                {
                    ...
                    pos: [
                        4.0,
                        { r: -1.763707940790424, i: 4.712720986149987e-16 },
                        { r: -0.37271534320159616, i: 6.194676430099382e-17 },
                    ],
                    color: [1.0, 0.0, 0.0],
                    args: ["Collection__1"],
                    labeled: true,
                ...
                { name: "c", type: "Parallel", color: [0.0, 0.0, 1.0], args: ["a", "C"], labeled: true },
                {
                    ...
                    pos: [
                        4.0,
                        { r: 0.3313708498984757, i: 2.859510109139477e-18 },
                        { r: -0.3999999999999999, i: -3.45173404361373e-18 },
                    ],
                    color: [1.0, 0.0, 0.0],
                    args: ["C0"],
                    labeled: true,
                ...
                {
                    name: "F",
                    type: "OtherPointOnCircle",
                    pos: [
                        4.0,
                        { r: -1.9313708498984756, i: -2.687555184762981e-17 },
                        { r: -0.3999999999999999, i: -5.566109035774775e-18 },
                    ],
                    color: [1.0, 0.0, 0.0],
                    args: ["E"],
                    pinned: true,
                ...
                { name: "d", type: "Join", color: [0.0, 0.0, 1.0], args: ["E", "A"], labeled: true },
                {
                    ...
                    type: "CircleByRadius",
                    pos: {
                        xx: { r: 0.010009171467685202, i: 1.7507477744037585e-19 },
                        yy: { r: 0.010009171467685202, i: 1.7507477744037585e-19 },
                        zz: 1.0,
                        xy: 0.0,
                        xz: { r: 0.20018342935370412, i: 1.7740456536387068e-18 },
                        yz: { r: -0.0165837382801321, i: -2.9007338898102005e-19 },
                    },
                    color: [0.0, 0.0, 1.0],
                    radius: 0.8819989450808214,
                    args: ["E"],
                    printname: "$C_{2}$",
                },
                ...
                { name: "Collection__2", type: "ConicBy2Foci1P", args: ["A", "B", "C"] },
                {
                    ...
                    type: "SelectConic",
                    pos: {
                        xx: { r: 0.0110062893081761, i: 1.5042710099323975e-19 },
                        yy: { r: 0.011006289308176093, i: 1.0444210746176384e-17 },
                        zz: 1.0,
                        xy: { r: 0.0031446540880503146, i: -1.6870684997469983e-18 },
                        xz: { r: 0.20754716981132076, i: -2.757195471369838e-18 },
                        yz: { r: 0.0943396226415094, i: 4.465590344928506e-17 },
                    },
                    color: [0.0, 0.0, 1.0],
                    args: ["Collection__2"],
                    printname: "$C_{4}$",
                ...
                { name: "Collection__3", type: "IntersectionConicLine", args: ["C4", "d"] },
                {
                    ...
                    pos: [
                        4.0,
                        { r: -0.1731107000870203, i: -1.3032476807755926e-16 },
                        { r: -0.3999999999999999, i: -1.9125958020581486e-18 },
                    ],
                    color: [1.0, 0.0, 0.0],
                    args: ["Collection__3"],
                    labeled: true,
                },
                {
                    ...
                    pos: [
                        4.0,
                        { r: -2.1126035856272667, i: 1.1047916970303941e-16 },
                        { r: -0.4, i: 4.004662558422439e-18 },
                    ],
                    color: [1.0, 0.0, 0.0],
                    args: ["Collection__3"],
                    labeled: true,
                ...
                { name: "Collection__4", type: "AngularBisector", args: ["a", "b", "L"] },
                {
                    ...
                    type: "SelectL",
                    pos: [
                        { r: 0.44444444444444453, i: -4.918226997824353e-17 },
                        { r: 3.088189045145525e-17, i: -4.1175853935273646e-17 },
                        4.0,
                    ],
                    color: [0.0, 0.0, 1.0],
                    args: ["Collection__4"],
