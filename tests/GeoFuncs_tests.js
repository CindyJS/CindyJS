...
describe("algorithm(‹string›)", function() {
    ...
    itCmd("algorithm(A)", "FreePoint");
    itCmd("algorithm(C0)", "CircleMP");
    itCmd("algorithm(Tr0)", "TrProjection");
    itCmd("algorithm(C1)", "Transform");
    itCmd("algorithm(a)", "Join");
    itCmd("algorithm(b)", "Orthogonal");
    itCmd("algorithm(c)", "Parallel");
    itCmd("algorithm(C)", "IntersectionCircleCircle");
    itCmd("algorithm(D)", "IntersectionCircleCircle");
    itCmd("algorithm(E)", "PointOnCircle");
    itCmd("algorithm(F)", "PointOnCircle");
    itCmd("algorithm(C2)", "CircleByRadius");
    itCmd("algorithm(C3)", "CircleByFixedRadius");
    itCmd("algorithm(C4)", "ConicFoci");
    itCmd("algorithm(G)", "IntersectionConicLine");
    itCmd("algorithm(H)", "IntersectionConicLine");
    itCmd("algorithm(K)", "PolarLine");
    itCmd("algorithm(e)", "PolarPoint");
    itCmd("algorithm(C5)", "Arc");
    itCmd("algorithm(L)", "Meet");
    itCmd("algorithm(f)", "AngularBisector");
});
