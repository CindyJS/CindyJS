...
describe("Prover: test free objects for random moves", function () {
    ...
    var exeptions = ["Text", "Calculation", "Equation", "Evaluate", "Plot", "Button", "ToggleButton", "EditableText"];

    frees = frees.filter(function (n) {
        return exeptions.indexOf(n) < 0;
    });
            ...
            geometry: [
                {
                    name: "A",
                    type: "Free",
                    pos: [2.2941176470588234, -4.0, -1.4705882352941175],
                    color: [1.0, 0.0, 0.0],
                    labeled: true,
                },
                {
                    name: "B",
                    type: "Free",
                    pos: [-2.0387096774193547, -4.0, -0.6451612903225806],
                    color: [1.0, 0.0, 0.0],
                    labeled: true,
                },
                {
                    name: "C",
                    type: "Free",
                    pos: [4.0, 1.2071005917159765, 0.591715976331361],
                    color: [1.0, 0.0, 0.0],
                    labeled: true,
                },
                ...
                { name: "Collection__1", type: "AngularBisector", args: ["b", "c", "A"] },
                {
                    name: "d",
                    type: "SelectL",
                    pos: [0.35934685894347934, -1.2644922426647693, 4.0],
                    color: [0.0, 0.0, 1.0],
                    args: ["Collection__1"],
                    labeled: true,
                },
                {
                    name: "",
                    type: "SelectL",
                    pos: [4.0, 1.1367309242995318, 3.1480918859052696],
                    color: [1.0, 1.0, 1.0],
                    args: ["Collection__1"],
                    size: 0,
                },
                { name: "Collection__2", type: "AngularBisector", args: ["a", "b", "C"] },
                {
                    name: "e",
                    type: "SelectL",
                    pos: [-0.37102114600759273, -0.7313220847983691, 4.0],
                    color: [0.0, 0.0, 1.0],
                    args: ["Collection__2"],
                    labeled: true,
                },
                ...
                { name: "Collection__3", type: "AngularBisector", args: ["a", "c", "B"] },
                {
                    name: "f",
                    type: "SelectL",
                    pos: [-1.6203679158952222, 0.18070364745627465, 4.0],
                    color: [0.0, 0.0, 1.0],
                    args: ["Collection__3"],
                    labeled: true,
                },
            ...
            geometry: [
                {
                    name: "A",
                    type: "Free",
                    pos: [4.0, -2.050420168067227, -0.8403361344537815],
                    color: [1.0, 0.0, 0.0],
                    labeled: true,
                },
                {
                    name: "B",
                    type: "Free",
                    pos: [0.2857142857142857, -4.0, 2.3809523809523814],
                    color: [1.0, 0.0, 0.0],
                    labeled: true,
                },
                {
                    name: "C",
                    type: "Free",
                    pos: [0.25396825396825395, -4.0, -0.5291005291005291],
                    color: [1.0, 0.0, 0.0],
                    labeled: true,
                },
                {
                    name: "D",
                    type: "Free",
                    pos: [4.0, 2.2010582010582014, 0.5291005291005291],
                    color: [1.0, 0.0, 0.0],
                    labeled: true,
                },
                ...
                { name: "b", type: "Join", color: [0.0, 0.0, 1.0], args: ["C", "D"], labeled: true },
                {
                    name: "E",
                    type: "PointOnLine",
                    pos: [-1.656041868455039, -4.0, -0.6388890413716075],
                    color: [1.0, 0.0, 0.0],
                    args: ["b"],
                    labeled: true,
                },
                {
                    name: "F",
                    type: "PointOnLine",
                    pos: [4.0, -0.801486761411016, -1.6314569839452548],
                    color: [1.0, 0.0, 0.0],
                    args: ["a"],
                    labeled: true,
                },
            ...
            geometry: [
                {
                    name: "A",
                    type: "Free",
                    pos: [4.0, -4.0, -1.3333333333333333],
                    color: [1.0, 0.0, 0.0],
                    labeled: true,
                    pinned: true,
                },
                ...
                },
                {
                    name: "D",
                    type: "Free",
                    pos: [0.0, -4.0, -1.3333333333333333],
                    color: [1.0, 0.0, 0.0],
                    labeled: true,
                    pinned: true,
                },
        ...
        cdy = CindyJS({
            ...
            geometry: [
                ...
                { name: "B", type: "Free", pos: [0.0, -0.0, 4.0], color: [1.0, 0.0, 0.0], labeled: true, pinned: true },
                {
                    name: "C0",
                    type: "CircleByRadius",
                    pos: { xx: -0.05555555555555555, yy: -0.05555555555555555, zz: 1.0, xy: 0.0, xz: 0.0, yz: 0.0 },
                    color: [0.0, 0.0, 1.0],
            ...
            geometry: [
                {
                    name: "A",
                    type: "Free",
                    pos: [-2.2857142857142856, -4.0, -0.5714285714285714],
                    color: [1.0, 0.0, 0.0],
                    pinned: true,
                    labeled: true,
                },
                ...
                { name: "C", type: "Free", pos: [0.0, -0.0, 4.0], color: [1.0, 0.0, 0.0], pinned: true, labeled: true },
                {
                    name: "C0",
                    type: "CircleByRadius",
                    pos: { xx: -0.1111111111111111, yy: -0.1111111111111111, zz: 1.0, xy: 0.0, xz: 0.0, yz: 0.0 },
                    color: [0.0, 0.0, 1.0],
                    radius: 3.0,
                    args: ["C"],
                    pinned: true,
                ...
                },
                {
                    ...
                    type: "PointOnCircle",
                    pos: [
                        { r: 1.3357992207441945e-15, i: -2.5649992745898987e-16 },
                        -4.0,
                        { r: -1.3333333333333333, i: 2.8552700268388423e-32 },
                    ],
                    color: [1.0, 0.0, 0.0],
                    args: ["C0"],
                    labeled: true,
                ...
                },
                {
                    name: "F",
                    type: "PointOnSegment",
                    pos: [-3.428571428571429, -4.0, -0.5714285714285714],
                    color: [1.0, 0.0, 0.0],
                    args: ["a"],
                    labeled: true,
                },
                ...
                },
                {
                    name: "E",
                    type: "PointOnLine",
                    pos: [4.0, 3.3333333333333335, 0.6666666666666666],
                    color: [1.0, 0.0, 0.0],
                    args: ["b"],
                    labeled: true,
                },
                {
                    name: "c",
                    type: "VerticalLine",
                    pos: [-0.6666666666666666, -0.0, 4.0],
                    color: [0.0, 0.0, 1.0],
                    pinned: true,
                    labeled: true,
                },
...
describe("RemoveElement: Pappos", function () {
    ...
    itCmd("removeelement(A); removeelement(C); allpoints()", "[B, D]");
    itCmd("alllines()", "[]");
});
