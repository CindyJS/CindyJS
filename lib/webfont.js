...
(function (window, document, undefined) {
    ...
    y.prototype.compare = function (a) {
        return this.c > a.c || (this.c === a.c && this.g > a.g) || (this.c === a.c && this.g === a.g && this.D > a.D)
            ? 1
            : this.c < a.c || (this.c === a.c && this.g < a.g) || (this.c === a.c && this.g === a.g && this.D < a.D)
            ? -1
            : 0;
    };
    ...
    B.prototype.parse = function () {
        ...
        if (-1 != this.a.indexOf("MSIE") || -1 != this.a.indexOf("Trident/")) {
            ...
            a = new A(
                ...
                0,
                0,
                new x(("Windows" == a && 6 <= c.c) || ("Windows Phone" == a && 8 <= b.c), !1)
            );
            ...
            /OPR\/[\d.]+/.test(this.a)
                ...
                ? ((a = "Unknown"),
                  ...
                  -1 != this.a.indexOf("Firefox")
                      ? ((a = "Firefox"), (b = z(E(this.a, /Firefox\/([\d\w\.]+)/, 1))), (b = 3 <= b.c && 5 <= b.g))
    ...
    function Q(a) {
        ...
        (b === a.v.serif && c === a.v["sans-serif"]) || (a.k.ga && R(a, b, c))
            ? n() - a.oa >= a.X
                ? a.k.ga && R(a, b, c) && (null === a.ca || a.ca.hasOwnProperty(a.m.getName()))
                    ? S(a, a.$)
                    : S(a, a.ka)
                : ja(a)
            : S(a, a.$);
    ...
    function la(a) {
        0 == --a.S &&
            ...
            (a.ea
                ? ((a = a.A),
                  a.F && s(a.q, [a.h.e(a.j, "active")], [a.h.e(a.j, "loading"), a.h.e(a.j, "inactive")]),
                  K(a, "active"))
                : J(a.A));
    }
    function U(a) {
    ...
    V.prototype.aa = function (a) {
        for (
            var b = this.d, c = new na(this.f.api, u(b), this.f.text), d = this.f.families, e = d.length, f = 0;
            f < e;
            f++
        ) {
            var g = d[f].split(":");
    ...
    this.WebFont ||
        ((this.WebFont = {}), (this.WebFont.load = k($.load, $)), this.WebFontConfig && $.load(this.WebFontConfig));
})(this, document);
