...
CSad.add = (a, b) => List.add(a, b);

CSad.sub = (a, b) => List.sub(a, b);
...
CSad.diff = (prog, varname, x0, grade) => {
    let erg;
...
CSad.adevaluate = (prog, varname, x0, grade) => {
...
CSad.autodiff = (ffunc, varname, xarr, grade) => {
    let erg = [];
