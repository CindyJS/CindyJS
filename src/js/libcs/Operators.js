import { csconsole, dump, csgeo, csmouse, csctx, csplay, cspause, csstop, csw, csh, globalInstance, CindyJS, cscompiled, shutdownHooks, simtime, simunit, setSpeed, canvas, dropped, dropPoint } from 'Setup'
...
evaluator.map$6 = function (args, modifs) {
    ...
    var w3 = cc(cc(w2, cc(inf, cc(w0, w1))), cc(w1, cc(inf, cc(w0, w2))));

    var v0 = evaluateAndHomog(args[3]);
    var v1 = evaluateAndHomog(args[4]);
    var v2 = evaluateAndHomog(args[5]);
    var v3 = cc(cc(v2, cc(inf, cc(v0, v1))), cc(v1, cc(inf, cc(v0, v2))));
...
evaluator.screen$0 = function (args, modifs) {
    ...
    var erg = [transf(0, 0), transf(csw, 0), transf(csw, csh), transf(0, csh)];
    return {
        ctype: "shape",
        type: "polygon",
        value: [erg],
...
export { statusbar, postfix_numb_degree, infix_take, infix_pow, infix_sqrt, infix_mult, infix_cross, infix_div, infix_add, infix_sub, prefix_not, comp_equals, comp_almostequals, comp_ult, comp_ugt, comp_ge, comp_le, comp_uge, comp_ule, comp_gt, comp_lt, comp_notequals, infix_in, infix_nin, infix_and, infix_or, comp_notalmostequals, infix_sequence, infix_concat, infix_remove, infix_common, infix_append, infix_prepend, infix_assign, infix_define, postfix_undefine, infix_semicolon, minCostMatching }