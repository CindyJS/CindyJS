...
//        he = this.faces[i].findEdge(tail, head);
//        if (he !== null) {
//            return he;
//        }
//    }
...
//    var dist;
//    var he = face.halfEdge0;
//
//    do {
//        face.checkConsistency();
//        // make sure edge is convex
//        dist = this._oppFaceDistance(he);
//
//        if (dist > tolerance) {
//            console.log("Edge " + he.getVertexString() + " non-convex by " + dist);
//
//            return false;
//        }
//
//        dist = this._oppFaceDistance(he.opposite);
//
//        if (dist > tolerance) {
...
//            console.log("Redundant vertex " + he.head().index +
...
//
//        if (face.mark === Face.VISIBLE) {
//            if (!this._checkFaceConvexity(face, tolerance)) {
//                convex = false;
//                break;
//            }
//        }
...
//    var dist, face;
//    var pointTol = 10 * tolerance;
//    var i, j;
//
//    if (!this._checkFaces(tolerance)) {
//        return false;
//    }
//
...
//        var pnt = this.pointBuffer[i].point;
//
...
//
//                if (dist > pointTol) {
//                    console.log("Point " + i + " " + dist + " above face " + face.getVertexString());
//                    return false;
//                }
//            }
//        }
